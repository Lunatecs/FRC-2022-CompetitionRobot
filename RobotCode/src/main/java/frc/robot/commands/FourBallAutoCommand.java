...
public class FourBallAutoCommand extends SequentialCommandGroup {
  ...
  public FourBallAutoCommand(IntakeSubsystem intake, DrivetrainSubsystem drive, TurretSubsystem turret, TowerSubsystem tower,
      ...
      addCommands(new InstantCommand(() -> intake.intakeOut()),
          ...
          new InstantCommand(() -> {
          shooter.setShooterVelocity(5800);
          }),
          new WaitCommand(0.5),
          new InstantCommand(() -> drive.resetEncoders()),
          new AutoStraightMoveCommand(drive, -1.6, drive.getAngle(), new PIDController(kP, 0, 0)),
          ...
          new InstantCommand(() -> drive.resetEncoders()),
          new AutoStraightMoveCommand(drive, -4.01, drive.getAngle(), new PIDController(kP, 0, 0)),
          new InstantCommand(() -> drive.resetEncoders()),
          new AutoStraightMoveCommand(drive, 4.4, drive.getAngle(), new PIDController(kP, 0, 0)),
          new AutoAimCommand(turret, limelight),
          new InstantCommand(() -> stopper.stopperIn()),
          new WaitCommand(1.0),
          new InstantCommand(() -> {
